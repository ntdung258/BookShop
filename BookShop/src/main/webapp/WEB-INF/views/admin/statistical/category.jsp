				...
				<div
					...
					<div class="templatemo-flex-row flex-content-row">
						...
						<div class="col-lg-3 col-md-3">
							<div class="panel-body">
								<form action="/BookShop/admin/home/view-chart-category-by-date"
									...
									<div class="col-lg-12 col-md-12 form-group">
										...
										<label>Date Start</label> <input type="date"
											...
											value="${sDate }" /> <span class="err" id="errStartDate"></span>
									</div>
									<div class="col-lg-12 col-md-12 form-group">
										...
										<label>Date End</label> <input type="date"
											...
											value="${eDate }" /> <span class="err" id="errEndDate"></span>
									</div>
									<div class="col-lg-12 col-md-12 form-group">
					...
					<div class="media">
						<div
							...
							<div class="panel-heading templatemo-position-relative">
								<h2 class="">Statistical table of the number of products
									sold by Category</h2>
							</div>
