					...
					<div class="templatemo-flex-row flex-content-row">
						<div class="col-lg-9 col-md-9">
							<div class="text-center">
								<h2 class="badge">Statistical chart of revenue by Year</h2>
							</div>
						...
						<div class="col-lg-3 col-md-3">
							<div class="panel-body">
								<form action="/BookShop/admin/home/view-chart-revenue-by-year-and-date"
					...
					<div class="media">
						<div
							...
							<div class="panel-heading templatemo-position-relative">
								<h2 class="">Sales statistics by Year</h2>
							</div>
								...
								<table class="table table-striped table-bordered">
									<thead>
										<tr class="bg-success">
											...
											<td><strong>Revenue by year</strong></td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${listOb }" var="ob">
											<tr>
												<td scope="row">${ob[0]}</td>
