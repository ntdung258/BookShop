				...
				<div
					...
					<div class="templatemo-flex-row flex-content-row">
						...
						<div class="col-lg-3 col-md-3">
							<div class="panel-body">
								<form action="/BookShop/admin/home/view-chart-revenue-by-day-and-date"
					...
					<div class="media">
						<div
							...
							<div class="panel-heading templatemo-position-relative">
								<h2 class="">Sales statistics by Day</h2>
							</div>
								...
								<table class="table table-striped table-bordered">
									<thead>
										<tr class="bg-success">
											...
											<td><strong>Revenue by day</strong></td>
										</tr>
									</thead>
									<tbody>
										<c:forEach items="${listOb }" var="ob">
											<tr>
												<td scope="row">${ob[0]}-${ob[1]}-${ob[2]}</td>
...
<script type="text/javascript">
	...
	<c:forEach items="${listOb }" var="ob">
	cateName.push('${ob[0]}-${ob[1]}-${ob[2]}')
	cateQuantity.push('${ob[3] }')
	</c:forEach>
